...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        form.addEventListener('submit', function (e) {
            ...
            const prompt = promptInput.value.trim();  // Get the user input
            if (prompt === '') return;  // Don't submit if prompt is empty
            ...
            fetch("{{ route('chatbot.generate') }}", {
                ...
                body: JSON.stringify({ prompt: prompt })  // Send the user's input
            })
